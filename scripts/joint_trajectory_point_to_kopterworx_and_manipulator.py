...
class JointTrajectoryToKopterworxAndManipulator:
  ...
  def __init__(self):
    ...
    self.uav_trajectory_point_pub = rospy.Publisher(
      'joint_trajectory_to_kopterworx_and_manipulator/multi_dof_trajectory_point_out', 
    ...
    rospy.Subscriber(
      'joint_trajectory_to_kopterworx_and_manipulator/joint_trajectory_point_in', 
...
if __name__ == '__main__':
  rospy.init_node('joint_trajectory_to_kopterworx_and_manipulator')
  handler = JointTrajectoryToKopterworxAndManipulator()
  handler.run()