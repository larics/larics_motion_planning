...
class JointTrajectoryToKopterworx:
    ...
    def __init__(self):
        ...
        if self.airdrop_flag == True:
            ...
            rospy.Subscriber('uav/cartographer/odometry_filtered', Odometry, 
                self.uavOdometryCallback, queue_size=1)
...
if __name__ == '__main__':
    ...
    rospy.init_node('joint_trajectory_with_airdrop_to_kopterworx')
    trajectory_to_ref = JointTrajectoryToKopterworx()
